...
<head>
    ...
    <title>Daftarkan Kos Anda - KosSmart</title>
...
<body>
    ...
    {{-- NAVBAR --}}
    <nav class="navbar">
        <a href="{{ route('home') }}" style="display:flex;align-items:center;gap:0.5rem;font-weight:800;font-size:1.1rem;color:var(--text);text-decoration:none;">
            <div style="width:30px;height:30px;background:linear-gradient(135deg,#f59e0b,#d97706);border-radius:8px;display:flex;align-items:center;justify-content:center;">
                <span class="material-symbols-rounded" style="font-size:16px!important;color:#fff;font-variation-settings:'FILL' 1,'wght' 600,'GRAD' 0,'opsz' 20;">home</span>
            </div>
            KosSmart
        </a>
        <a href="{{ route('home') }}" style="color:var(--muted);font-size:0.84rem;font-weight:600;text-decoration:none;display:flex;align-items:center;gap:0.35rem;transition:color 0.2s;" onmouseover="this.style.color='var(--text)'" onmouseout="this.style.color='var(--muted)'">
            <span class="material-symbols-rounded" style="font-size:18px!important;">arrow_back</span>
            Kembali ke Beranda
        </a>
    </nav>
    ...
    <div style="max-width:680px;margin:0 auto;padding:3rem 1.5rem 5rem;">
        ...
        <div style="text-align:center;margin-bottom:2.5rem;">
            <div style="display:inline-flex;align-items:center;gap:0.4rem;background:rgba(124,58,237,0.07);border:1px solid rgba(124,58,237,0.18);color:var(--purple);font-size:0.76rem;font-weight:700;padding:0.3rem 0.85rem;border-radius:100px;margin-bottom:1rem;">
                <span class="material-symbols-rounded" style="font-size:14px!important;">apartment</span>
    ...
    <script>
        ...
        // Jika ada error server-side, langsung ke step yang error
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('[name="tipe_kepemilikan"]').forEach(r => {
                r.addEventListener('change', toggleBuktiLabel);
            });
