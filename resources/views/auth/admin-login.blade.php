...
<head>
    ...
    <title>Login Admin - KosSmart</title>
...
<body class="bg-primary min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8 floating-animation">
            ...
            {{-- [DIUBAH] Label portal --}}
            <p class="text-gray-400">Portal Admin Kos</p>
        </div>
        ...
        <div class="card-auth rounded-2xl shadow-2xl p-8">
            ...
            <p class="text-gray-400 mb-6">Masuk ke akun Admin Kos Anda</p>
            
            {{-- [DIUBAH] Form action → route('admin.login') --}}
            ...
            {{-- [DIUBAH] Tidak ada link "Daftar Sekarang" untuk admin --}}
