...
<div x-data="{ showUlasanModal: false }" class="mb-6">
    ...
    <div class="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl p-5 flex items-center justify-between shadow-lg">
        ...
        <button @click="showUlasanModal = true"
                class="flex-shrink-0 ml-4 px-5 py-2.5 bg-white text-yellow-600 font-bold text-sm rounded-xl hover:bg-[rgba(245,158,11,0.08)] transition shadow-md whitespace-nowrap">
            ⭐ Tulis Ulasan
        </button>
    </div>
            ...
            <form action="{{ route('user.ulasan.store', $billingPerluDiulas) }}"
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        {{-- Label --}}
                        <span class="ml-2 text-sm font-semibold text-gray-500 min-w-[120px]"
                ...
                {{-- Komentar --}}
                <div>
                    <label for="komentar" class="block text-sm font-semibold text-gray-600 mb-2">
                    ...
                    <textarea id="komentar"
                              ...
                              class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-yellow-400 focus:border-transparent resize-none text-sm text-gray-600 placeholder-[#4b5563]">{{ old('komentar') }}</textarea>
                ...
                {{-- Info --}}
                <div class="bg-[rgba(245,158,11,0.08)] border border-yellow-100 rounded-xl p-3 flex items-start gap-2">
                ...
                <div class="flex gap-3 pt-1">
                    <button type="button"
                            ...
                            class="flex-1 px-4 py-3 border border-gray-200 text-gray-500 rounded-xl hover:bg-gray-50 transition font-medium text-sm">
                        Lewati
                    </button>
                    <button type="submit"
                            :disabled="rating === 0"
...
<div class="mb-6 bg-[rgba(245,158,11,0.08)] border-l-4 border-yellow-500 p-6 rounded-lg">
    <div class="flex items-start">
        ...
        <div class="flex-1">
            <h3 class="font-bold text-yellow-700 mb-2">Permintaan checkout Anda sedang diproses admin.</h3>
        </div>
    </div>
</div>
@endif
    ...
    <div class="p-6">
        <div class="space-y-4">
            ...
            <div class="flex justify-between items-center">
                ...
                <span class="px-3 py-1 bg-[rgba(52,211,153,0.15)] text-green-400 text-sm font-medium rounded-full">Aktif</span>
            </div>
            <div class="flex justify-between items-center">
        ...
        <div class="mt-4 pt-4 border-t border-gray-200">
            ...
            <div class="flex flex-wrap gap-2">
                @foreach($activeRent->room->facilities as $facility)
                    <span class="px-3 py-1 bg-[rgba(245,158,11,0.08)] text-yellow-400 text-xs font-medium rounded-full">
                        {{ $facility }}
                    </span>
                @endforeach
            </div>
