...
<div class="mb-8 bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-lg shadow-sm">
    <div class="flex items-start">
        ...
        <div class="flex-1">
            <h3 class="font-bold text-yellow-800 text-lg mb-2">Permintaan Checkout Sedang Diproses</h3>
            <p class="text-yellow-700 mb-4">
                Permintaan checkout Anda untuk kamar <strong>{{ $activeRent->room->room_number }}</strong> sedang ditinjau oleh admin. 
    ...
    <div class="p-6">
        <div class="space-y-4">
            ...
            <div class="flex justify-between items-center">
                ...
                <span class="font-medium text-gray-800">{{ $activeRent->start_date->diffInMonths(now()) }} Bulan</span>
            </div>
            <div class="flex justify-between items-center">
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-start">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <p class="text-sm text-gray-600">Sedang dalam proses review...</p>
                </div>
            </div>
...
<div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-6">
    <div class="flex items-start">
        ...
        <div>
            <h3 class="font-bold text-blue-900 mb-2">Pertanyaan?</h3>
