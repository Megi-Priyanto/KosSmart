...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between mb-2">
        <div>
            <h1 class="text-2xl font-bold text-gray-100">Status Booking Anda</h1>
    ...
    <!-- Status Timeline -->
    <div class="bg-[#1e293b] rounded-xl shadow-lg border border-[#334155] p-6 mb-6">
        <div class="mb-6">
            <h3 class="text-lg font-bold text-gray-100 mb-4">Status Saat Ini</h3>
        ...
        <div class="relative">
            ...
            <div class="space-y-6">
                ...
                <div class="relative flex items-start pl-12">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-gray-100">Booking Diterima</h4>
                ...
                <div class="relative flex items-start pl-12">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-gray-100">Pembayaran Lunas</h4>
                        <p class="text-sm text-gray-600">
                            @if($rent->status == 'active')
                                Selesai
                            @else
                ...
                <div class="relative flex items-start pl-12">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-gray-100">Mulai Menempati</h4>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-[#1e293b] rounded-xl shadow-none border border-[#334155] p-6">
            <h3 class="text-lg font-bold text-gray-100 mb-4">Informasi Kamar</h3>
            ...
            <div class="space-y-3">
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-gray-100">{{ $rent->room->room_number }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Lantai</span>
                    <span class="font-semibold text-gray-100">{{ $rent->room->floor }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Tipe</span>
                    <span class="font-semibold text-gray-100">{{ ucfirst($rent->room->type) }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Ukuran</span>
                    <span class="font-semibold text-gray-100">{{ $rent->room->size }} m²</span>
                </div>
            </div>
            
            <div class="mt-4 pt-4 border-t border-[#334155]">
                <a href="{{ route('user.rooms.show', $rent->room->id) }}" 
                   class="text-yellow-400 hover:text-yellow-500 text-sm font-medium flex items-center">
                    Lihat Detail Kamar
        ...
        <!-- Info Pembayaran -->
        <div class="bg-[#1e293b] rounded-xl shadow-none border border-[#334155] p-6">
            <h3 class="text-lg font-bold text-gray-100 mb-4">Informasi Pembayaran</h3>
            
            <div class="space-y-3 mb-4">
                <div class="flex justify-between">
                    <span class="text-gray-600">Harga Sewa/Bulan</span>
                    <span class="font-semibold text-gray-100">Rp {{ number_format($rent->monthly_rent, 0, ',', '.') }}</span>
                </div>
                <div class="flex justify-between">
                ...
                <div class="flex justify-between pt-3 border-t border-orange-200 bg-orange-50 px-3 py-2 rounded-lg">
                    ...
                    <span class="font-semibold text-yellow-600">Rp {{ number_format($rent->monthly_rent - $rent->deposit_paid, 0, ',', '.') }}</span>
                </div>
            </div>
            ...
            <div class="mt-4 pt-4 border-t border-[#334155]">
                <p class="text-sm font-medium text-gray-200 mb-2">Bukti Transfer DP:</p>
                @php
                    $imagePath = str_replace('Bukti DP: ', '', $rent->notes);
                @endphp
                <img src="{{ asset('storage/' . $imagePath) }}" 
                     alt="Bukti Transfer"
                     class="w-full rounded-lg border border-[#334155] cursor-pointer hover:opacity-90"
            ...
            @if($rent->status == 'pending')
            <div class="mt-4 p-3 bg-yellow-900/20 border border-yellow-200 rounded-lg">
    ...
    <div class="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl border border-yellow-200 p-6 mb-6">
        <h3 class="text-lg font-bold text-gray-100 mb-4">Jadwal</h3>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                <p class="text-sm text-gray-600 mb-1">Tanggal Booking</p>
                <p class="font-semibold text-gray-100">{{ $rent->created_at->format('d M Y') }}</p>
                <p class="text-xs text-gray-500">{{ $rent->created_at->diffForHumans() }}</p>
            </div>
            <div>
                <p class="text-sm text-gray-600 mb-1">Mulai Sewa</p>
                <p class="font-semibold text-gray-100">{{ $rent->start_date->format('d M Y') }}</p>
    ...
    <div class="bg-yellow-900/30 border-l-4 border-yellow-500 p-6 rounded-lg mb-6 ring-1 ring-yellow-200">
        <div class="flex items-start">
            ...
            <div>
                <h4 class="font-bold text-yellow-300 mb-2">Menunggu Konfirmasi Admin</h4>
    ...
    @elseif($rent->status == 'active')
    <div class="bg-green-900/40 border-l-4 border-green-500 p-6 rounded-lg mb-6 ring-1 ring-green-200">
        <div class="flex items-start">
    ...
    <!-- Contact Admin -->
    <div class="bg-[#1e293b] rounded-xl shadow-none border border-[#334155] p-6">
        <h3 class="text-lg font-bold text-gray-100 mb-4">Hubungi Admin</h3>
        
        @if($rent->room->kosInfo)
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="tel:{{ $rent->room->kosInfo->phone }}" 
               class="flex min-w-0 items-center space-x-3 p-4 border border-[#334155] rounded-lg hover:bg-[#0f172a] transition-colors">
            ...
            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $rent->room->kosInfo->whatsapp) }}"
               ...
               class="flex min-w-0 items-center space-x-3 p-4 border border-[#334155] rounded-lg hover:bg-[#0f172a] transition-colors">
                ...
                <div class="bg-green-900/40 p-3 rounded-lg flex-shrink-0">
