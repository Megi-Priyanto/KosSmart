...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Status Pembatalan Booking</h1>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        ...
        <!-- Status Badge -->
        <div class="mb-6">
            <h3 class="text-lg font-bold text-gray-800 mb-3">Status Saat Ini</h3>
            <span class="inline-flex items-center space-x-2 px-4 py-2 rounded-full text-lg font-semibold
                ...
                @elseif($cancelBooking->status == 'rejected') bg-red-200 text-red-900 ring-1 ring-red-400
                @endif">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="space-y-4">
                <h4 class="font-bold text-gray-800 pb-2 border-b">Informasi Booking</h4>
                <div>
                    <p class="text-sm text-gray-600">Kamar</p>
                    <p class="font-semibold text-gray-800">{{ $cancelBooking->rent->room->room_number }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="font-semibold text-gray-800">{{ $cancelBooking->created_at->format('d M Y, H:i') }}</p>
                </div>
            </div>

            <div class="space-y-4">
                <h4 class="font-bold text-gray-800 pb-2 border-b">Rekening Pengembalian</h4>
                <div>
                    <p class="text-sm text-gray-600">Bank</p>
                    <p class="font-semibold text-gray-800">{{ $cancelBooking->bank_name }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Nomor Rekening</p>
                    <p class="font-semibold text-gray-800">{{ $cancelBooking->account_number }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Atas Nama</p>
                    <p class="font-semibold text-gray-800">{{ $cancelBooking->account_holder_name }}</p>
                </div>
            </div>
        ...
        <div class="mt-6 p-6 bg-green-50 border-l-4 border-green-500 rounded-lg">
            ...
            <div class="mt-4">
                <p class="text-sm font-semibold text-green-800 mb-2">Bukti Transfer dari Admin:</p>
        ...
        <div class="mt-6 p-6 bg-red-50 border-l-4 border-red-500 rounded-lg">
