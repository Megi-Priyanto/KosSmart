...
<div class="space-y-6" x-data="bookingForm()">
    ...
    <div class="flex items-center justify-between mb-2">
        <div>
            <h1 class="text-2xl font-bold text-gray-100">Booking Kamar {{ $room->room_number }}</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-[#1e293b] rounded-xl shadow-none border border-[#334155] overflow-hidden">
                    ...
                    <!-- Form Header -->
                    <div class="p-6 border-b border-[#334155] bg-[#0f172a]">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="date" 
                                   ...
                                   class="w-full px-4 py-3 border border-[#334155] rounded-lg focus:ring-2 focus:ring-yellow-500"
                                   required>
                            @error('start_date')
                        ...
                        <div>
                            ...
                            <div x-show="selectedMethod" x-transition class="mt-4">
                                ...
                                <div x-show="selectedMethod !== 'qris'" class="p-4 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl">
                                    <p class="font-semibold text-gray-100 mb-3">Transfer ke:</p>
                                    <div class="space-y-2">
                                        <div class="flex justify-between">
                                            <span class="text-gray-600" x-text="selectedMethod === 'manual_transfer' ? 'Bank:' : 'E-Wallet:'"></span>
                                            <span class="font-semibold text-gray-100" x-text="getSubMethodLabel()"></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600" x-text="selectedMethod === 'manual_transfer' ? 'No. Rekening:' : 'Nomor:'"></span>
                                            <span class="font-semibold text-gray-100 flex items-center">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-semibold text-gray-100" x-text="getAccountHolder()"></span>
                                        </div>
                                ...
                                <!-- QRIS -->
                                <div x-show="selectedMethod === 'qris'" class="bg-yellow-900/20 rounded-xl border border-yellow-200 p-6 rounded-xl text-center">
                                    <p class="font-semibold text-gray-100 mb-4">Scan QR Code untuk Pembayaran</p>
                        ...
                        <div x-show="selectedMethod" x-transition>
                            ...
                            <div x-show="imagePreview" class="mt-4">
                                <p class="text-sm font-medium text-gray-200 mb-2">Preview:</p>
                                <img :src="imagePreview" class="max-w-md rounded-lg border-2 border-[#334155]">
                            </div>
                        </div>

                        <!-- Agreement -->
                        <div>
                            <div class="flex items-start p-3 bg-[#0f172a] rounded-lg">
                                <input type="checkbox" 
                                       name="agreement" 
                                       value="1"
                                       id="agreement"
                                       ...
                                       required>
                                <label for="agreement" class="ml-3 text-sm text-gray-200">
                    ...
                    <!-- Form Footer -->
                    <div class="p-6 bg-[#0f172a] border-t border-[#334155]">
                        <button type="submit" 
            ...
            <div class="space-y-6">
                ...
                <div class="bg-[#1e293b] rounded-xl shadow-lg border-2 border-slate-200 p-6 sticky top-6">
                    <h3 class="text-lg font-bold text-gray-100 mb-4">Ringkasan Booking</h3>
                ...
                <div class="bg-yellow-900/20 rounded-xl border border-yellow-200 p-6">
                    ...
                    <div class="space-y-2">
                        <a href="tel:{{ $room->kosInfo->phone }}" 
                           class="flex items-center text-sm text-gray-200 hover:text-yellow-600">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $room->kosInfo->whatsapp) }}" 
                           target="_blank"
                           class="flex items-center text-sm text-gray-200 hover:text-green-600">
    ...
    <div x-show="showPaymentModal" 
        ...
        <div @click.away="showPaymentModal = false"
             ...
             class="bg-[#1e293b] rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            
            <div class="sticky top-0 bg-[#1e293b] border-b p-6 flex justify-between items-center">
                <h3 class="text-2xl font-bold text-gray-100">Pilih Metode Pembayaran</h3>
                <button @click="showPaymentModal = false" class="text-gray-600 hover:text-gray-600">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="border-2 border-[#334155] rounded-xl p-4">
                    <h4 class="font-bold text-lg mb-3">{{ $data['label'] }}</h4>
                    
                    @if($method === 'qris')
                    <button type="button"
                            @click="selectPayment('qris', 'qris')"
                            class="w-full p-4 border-2 rounded-lg hover:border-yellow-500 hover:bg-yellow-900/20 transition-all text-left"
                            :class="selectedMethod === 'qris' ? 'border-yellow-500 bg-yellow-900/20' : 'border-[#334155]'">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <button type="button"
                                ...
                                :class="selectedSubMethod === '{{ $key }}' ? 'border-amber-500 bg-amber-50' : 'border-[#334155]'">
                            <div class="flex items-center justify-between">
                                <div>
