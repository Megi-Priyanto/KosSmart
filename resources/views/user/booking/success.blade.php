...
<div class="space-y-6">
    ...
    <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-24 h-24 bg-green-900/40 rounded-full mb-6">
            <svg class="w-12 h-12 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
        </div>
        
        <h1 class="text-3xl font-bold text-gray-100 mb-2">Booking Berhasil!</h1>
        <p class="text-gray-600">Terima kasih telah melakukan booking di KosSmart</p>
    </div>
    
    <!-- Info Card -->
    <div class="bg-[#1e293b] rounded-xl shadow-lg border border-[#334155] p-8 mb-6">
        <div class="space-y-4">
            <div class="flex items-start bg-yellow-900/20 border-l-4 border-yellow-400 p-4 rounded-lg">
                <svg class="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <div>
                    <p class="font-semibold text-gray-100">Booking Anda sedang dalam proses verifikasi</p>
            ...
            <div class="flex items-start bg-yellow-900/20 border-l-4 border-yellow-400 p-4 rounded-lg">
                ...
                <div>
                    <p class="font-semibold text-gray-100">Cek email Anda</p>
            ...
            <div class="flex items-start bg-yellow-900/20 border-l-4 border-yellow-400 p-4 rounded-lg">
                ...
                <div>
                    <p class="font-semibold text-gray-100">Status booking</p>
    ...
    <div class="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl border border-purple-200 p-6 mb-6">
        <h3 class="text-lg font-bold text-gray-100 mb-4">Langkah Selanjutnya</h3>
        <ol class="space-y-3">
            <li class="flex items-start">
                ...
                <p class="text-gray-200">Tunggu konfirmasi dari admin melalui telepon atau WhatsApp</p>
            </li>
            <li class="flex items-start">
                ...
                <p class="text-gray-200">Lakukan pembayaran sisa jika booking disetujui</p>
            </li>
            <li class="flex items-start">
                ...
                <p class="text-gray-200">Serahkan dokumen identitas (KTP/SIM/Paspor)</p>
            </li>
            <li class="flex items-start">
                ...
                <p class="text-gray-200">Terima kunci kamar dan mulai menempati</p>
            </li>
        </ol>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <a href="{{ route('user.rooms.index') }}" 
           class="flex items-center justify-center space-x-2 border-2 border-[#334155] text-gray-200 py-3 rounded-lg hover:bg-[#0f172a] font-semibold transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mt-8 text-center">
        ...
        <a href="https://wa.me/6281234567890" 
           target="_blank"
           class="inline-flex items-center space-x-2 text-green-600 hover:text-green-400 font-medium">
