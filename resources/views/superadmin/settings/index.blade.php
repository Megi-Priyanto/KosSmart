...
<form action="{{ route('superadmin.settings.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="bg-slate-800 border border-gray-700 rounded-xl p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Preview -->
            <div>
                <label class="text-gray-300 mb-2">Logo Saat Ini</label>
                <div class="bg-slate-900 border-2 border-gray-700 rounded-lg p-4 flex items-center justify-center h-40">
            ...
            <div>
                ...
                <div class="bg-slate-900 border-2 border-dashed border-gray-600 rounded-lg 
                    ...
                    <label for="logoInput" class="cursor-pointer w-full h-full 
                                               flex flex-col items-center justify-center">

                        <!-- PREVIEW -->
                        <div id="logoPreview"
                             class="w-24 h-24 mb-3 rounded-md 
    ...
    <div class="bg-slate-800 border border-gray-700 rounded-xl p-6 mb-6">
        ...
        <p class="text-sm text-gray-400 mb-4">
            Gambar banner untuk user yang sudah memiliki kamar
        </p>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Preview -->
            <div>
                <label class="text-gray-300 mb-2">Hero Image Saat Ini</label>
                <div class="bg-slate-900 border-2 border-gray-700 rounded-lg p-4 flex items-center justify-center h-40">
            ...
            <div>
                ...
                <div class="bg-slate-900 border-2 border-dashed border-gray-600 rounded-lg 
                    ...
                    <label for="tenantHeroInput" class="cursor-pointer w-full h-full 
                                               flex flex-col items-center justify-center">

                        <!-- PREVIEW -->
                        <div id="tenantHeroPreview"
                             class="w-24 h-24 mb-3 rounded-md 
                                    bg-slate-800 flex items-center justify-center 
                                    overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="bg-slate-900 border-2 border-gray-700 rounded-lg p-4 flex items-center justify-center h-40">
                    @if(str_starts_with($heroImageEmpty, 'settings/'))
                        <img src="{{ asset('storage/' . $heroImageEmpty) }}" alt="Hero" class="max-h-full max-w-full object-contain">
                    @else
                        <img src="{{ asset($heroImageEmpty) }}" alt="Hero" class="max-h-full max-w-full object-contain">
                    @endif
                </div>
            </div>
            ...
            <div>
                ...
                <div class="bg-slate-900 border-2 border-dashed border-gray-600 rounded-lg 
                    ...
                    <label for="emptyHeroInput" class="cursor-pointer w-full h-full 
                                               flex flex-col items-center justify-center">

                        <!-- PREVIEW -->
                        <div id="emptyHeroPreview"
                             class="w-24 h-24 mb-3 rounded-md 
                                    bg-slate-800 flex items-center justify-center 
                                    overflow-hidden">
