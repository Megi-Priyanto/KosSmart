...
@section('title', 'Edit Tempat Kos')
@section('page-title', 'Edit Tempat Kos')
        ...
        <div class="bg-slate-800 rounded-xl p-6 border border-slate-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           name="nama_kos" 
                           value="{{ old('nama_kos', $tempatKos->nama_kos) }}"
                ...
                <div>
                    ...
                    <input type="email" 
                           name="email" 
                           value="{{ old('email', $tempatKos->email) }}"
                ...
                <div>
                    ...
                    <input type="tel" 
                           name="telepon" 
                           value="{{ old('telepon', $tempatKos->telepon) }}"
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" 
                                   name="status" 
                                   value="active" 
                                   {{ old('status', $tempatKos->status) === 'active' ? 'checked' : '' }}
                        ...
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" 
                                   name="status" 
                                   value="inactive" 
                                   {{ old('status', $tempatKos->status) === 'inactive' ? 'checked' : '' }}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" 
                              ...
                              required>{{ old('alamat', $tempatKos->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" 
                           name="provinsi" 
                           value="{{ old('provinsi', $tempatKos->provinsi) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           name="kode_pos" 
                           value="{{ old('kode_pos', $tempatKos->kode_pos) }}"
                ...
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ Storage::url($tempatKos->logo) }}" 
                             alt="Current Logo"
                             class="w-32 h-32 object-cover rounded-lg border-2 border-slate-600">
                    </div>
                    @endif
                    ...
                    <div id="logoPreview" class="mt-3 hidden">
                        <p class="text-xs text-slate-400 mb-2">Preview logo baru:</p>
                        <img src="" alt="Preview" class="w-32 h-32 object-cover rounded-lg border-2 border-yellow-500">
                    </div>
                </div>
            </div>
        </div>
