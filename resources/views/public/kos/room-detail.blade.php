...
@push('page-styles')
        ...
        /* ── PANELS ── */
        .panel{background:var(--card);border:1px solid rgba(15,23,42,0.08);border-radius:16px;overflow:hidden;}
        .panel-body{padding:1.5rem;}

        /* ── STAT PILLS ── */
        .quick-stat{text-align:center;background:rgba(15,23,42,0.03);border:1px solid rgba(15,23,42,0.08);border-radius:12px;padding:0.85rem 0.5rem;}
        ...
        /* ── BOOKING CARD ── */
        .booking-card{background:#ffffff;border:2px solid rgba(217,119,6,0.2);border-radius:18px;padding:1.5rem;position:sticky;top:5.5rem;}
        ...
        /* ── RELATED ── */
        .related-card{background:#ffffff;border:1px solid rgba(15,23,42,0.08);border-radius:12px;overflow:hidden;text-decoration:none;transition:all 0.2s;display:block;}
        ...
        /* ── GALERI PLACEHOLDER ── */
        .thumb-placeholder{height:76px;background:linear-gradient(135deg,#e2e8f0,#cbd5e1);display:flex;align-items:center;justify-content:center;}
@endpush
    ...
    <div style="display:grid;grid-template-columns:1fr 320px;gap:1.5rem;align-items:start;">
        ...
        <div style="display:flex;flex-direction:column;gap:1.25rem;">
            ...
            <div class="panel">
                ...
                <div x-data="{ images: {{ json_encode($images) }}, current: 0 }">
                    <div style="aspect-ratio:16/9;background:#ffffff;position:relative;" class="group">
                    ...
                    <!-- Thumbnails -->
                    <div style="padding:0.75rem;background:rgba(248,250,252,0.95);display:flex;gap:8px;overflow-x:auto;">
                ...
                @else
                <div style="aspect-ratio:16/9;background:linear-gradient(135deg,#e2e8f0,#cbd5e1);display:flex;align-items:center;justify-content:center;">
                    <span class="material-symbols-rounded" style="font-size:72px;color:rgba(15,23,42,0.2);">image</span>
                </div>
                @endif
            </div>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <!-- Quick Stats -->
                    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:0.75rem;padding:1rem 0;border-top:1px solid rgba(15,23,42,0.08);border-bottom:1px solid rgba(15,23,42,0.08);margin-bottom:1.25rem;">
            ...
            <!-- Info Kos -->
            @if($kosInfo)
            <div style="background:linear-gradient(135deg,rgba(245,158,11,0.1),rgba(217,119,6,0.06));border:1px solid rgba(245,158,11,0.2);border-radius:16px;padding:1.25rem;">
                        ...
                        <a href="{{ route('public.kos.room-detail', $r) }}" class="related-card">
                            ...
                            @else
                                <div class="thumb-placeholder">
                                    <span class="material-symbols-rounded" style="font-size:28px;color:rgba(15,23,42,0.25);">bed</span>
                                </div>
                            @endif
        ...
        <div>
            <div class="booking-card">
                ...
                <div style="display:flex;flex-direction:column;gap:0.5rem;padding-top:1rem;border-top:1px solid rgba(15,23,42,0.08);">
                    <div class="check-row">
                        <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            ...
            <!-- Register Prompt -->
            <div style="background:rgba(217,119,6,0.05);border:1px solid rgba(217,119,6,0.15);border-radius:14px;padding:1.1rem;margin-top:0.85rem;">
