    ...
    <div class="grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            <div class="text-xl font-bold text-white mb-6 flex items-center pb-3 border-b-2 border-slate-700/50">
                ...
                <div>
                    <h2 class="text-lg font-bold text-white">Informasi Umum</h2>
                </div>
            </div>
                <div>
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            <div class="text-xl font-bold text-white mb-6 flex items-center pb-3 border-b-2 border-slate-700/50">
                ...
                <div>
                    <h2 class="text-lg font-bold text-white">Alamat dann Lokasi</h2>
                </div>
            </div>
            <div class="flex items-start space-x-3 bg-slate-800 p-4 rounded-lg border border-slate-700 mb-2">
            ...
            @if($kos->postal_code)
            <div class="bg-slate-800 p-3 rounded-lg border border-slate-700 mb-2">
    ...
    <div class="grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            <div class="text-xl font-bold text-white mb-6 flex items-center pb-3 border-b-2 border-slate-700/50">
                ...
                <div>
                    <h2 class="text-lg font-bold text-white">Informasi Kontak</h2>
                </div>
            </div>
            <div class="flex items-center space-x-3 bg-slate-800 p-4 rounded-lg border border-slate-700 hover:border-orange-500 transition-all mb-2">
            ...
            @if($kos->whatsapp)
            <div class="flex items-center space-x-3 bg-slate-800 p-4 rounded-lg border border-slate-700 hover:border-green-500 transition-all mb-2">
            ...
            @endif
            @if($kos->email)
            <div class="flex items-center space-x-3 bg-slate-800 p-4 rounded-lg border border-slate-700 hover:border-blue-500 transition-all mb-2">
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            ...
            <div class="bg-slate-800 p-5 rounded-lg border border-slate-700 hover:border-green-500 transition-all mb-2">
            ...
            <div class="bg-slate-800 p-5 rounded-lg border border-slate-700 hover:border-red-500 transition-all mb-2">
                <div class="flex items-center space-x-4">
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            <div class="text-xl font-bold text-white mb-6 flex items-center pb-3 border-b-2 border-slate-700/50">
                ...
                <div>
                    <h2 class="text-lg font-bold text-white">Fasilitas Umum</h2>
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            <div class="text-xl font-bold text-white mb-6 flex items-center pb-3 border-b-2 border-slate-700/50">
                ...
                <div>
                    <h2 class="text-lg font-bold text-white">Peraturan Kos</h2>
