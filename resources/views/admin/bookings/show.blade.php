...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            ...
            <div class="mt-4 pt-4 border-t border-slate-700 flex gap-3">
                ...
                <a href="tel:{{ $booking->user->phone }}" 
                   class="flex-1 text-center px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold text-sm flex items-center justify-center transition-all shadow-lg">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                    </svg>
                    Telepon
                ...
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $booking->user->phone) }}" 
                   target="_blank"
                   class="flex-1 text-center px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold text-sm flex items-center justify-center transition-all shadow-lg">
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            ...
            <div class="mt-4 pt-4 border-t border-slate-700">
                <a href="{{ route('admin.rooms.show', $booking->room->id) }}" 
                   class="text-orange-400 hover:text-orange-300 text-sm font-semibold inline-flex items-center">
                    Lihat Detail Kamar 
        ...
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-slate-700/50 p-6 shadow-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="p-4 bg-green-500/10 rounded-lg border border-green-500/30 md:col-span-2">
                    <label class="text-xs text-green-400 font-semibold uppercase tracking-wide mb-2 block flex items-center">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        Disetujui Pada
        ...
        <div class="bg-blue-500/10 border border-blue-500/30 rounded-lg p-6 shadow-xl">
            ...
            <p class="text-sm text-slate-400 mt-3 pt-3 border-t border-blue-500/20">
                Oleh: <span class="font-semibold text-blue-300">{{ \App\Models\User::find($booking->approved_by)->name ?? 'Admin' }}</span>
            </p>
            @endif
        </div>
        @endif
    ...
    <div class="space-y-6">
        ...
        @if($booking->status == 'pending')
        <div class="bg-slate-800/90 backdrop-blur rounded-xl border-2 border-yellow-600 p-6 shadow-2xl">
            <h3 class="text-xl font-bold text-yellow-600 mb-6 flex items-center pb-3 border-b-2 border-yellow-600">
                <div class="p-2 bg-gradient-to-br from-yellow-700 to-yellow-600 rounded-lg border-2 border-yellow-500 mr-3 shadow-lg">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-data="{ showReject: false }">
                <button @click="showReject = !showReject" 
                        class="w-full bg-red-500/20 text-red-300 py-2 rounded-lg hover:bg-red-500/30 font-medium text-sm border border-red-500/50 transition-all">
                    Tolak Booking
                </button>
